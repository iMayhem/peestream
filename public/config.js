window.__CONFIG__ = {
  ...
  // The website uses the scraper-hub (port 3000) provider API for metadata + scraping. TMDB is fetched directly (no proxy).
  VITE_CORS_PROXY_URL: "|type=api|https://providers.peestream.in",
